...
sBOX is an ETF designed and issued by Li Xiaolai, which is converted from BTC, ETH, EOS, DOT, MOB, XIN and UNI according to a fixed ratio, and at present, the transactions related to BOX conducted by users in ExinOne are bought/sold by ExinOne platform agents.
