...
1️⃣ 行情：您可以通过 ExinOne 查看加密货币的市场行情相关信息，设置价格提醒；

2️⃣ 交易：ExinOne 聚合了 Binance、OKX、Bybit、Gateio、BigONE、MixSwap 等交易所，您无需注册无需进行 KYC 即可交易上述交易所的代币，目前有三种交易模式：
...
3️⃣ 理财：ExinOne 的「活期宝」功能为您提供了一些资产的理财服务，目前支持的资产有：

- USDT、pUSD、XIN、ZEN、EOS

4️⃣ 借贷：ExinOne 提供质押借贷服务，可将自己持有的资产进行质押，借出 USDT。

5️⃣ 钱包：ExinOne 集成了 Mixin 钱包的功能，使您能在 ExinOne 内查询、操作自己 Mixin 钱包的资产。
